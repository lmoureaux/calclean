...
function printusage()
  ...
  print('Where:')
  print('  <datafile> is a file containing the output of eeanalyzer')
...
/**
 * @file
 * @brief  Defines cuts for @ref calo::goodee_filter "goodee_filter"
 * @author @c tools/eeanalyzer.lua
 * @date   ]] .. os.date('%F') .. [[\n
 * @warning This file was generated automatically by @c tools/eeanalyzer.lua. It
